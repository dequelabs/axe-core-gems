...
Then 'the page should not be accessible within "$inclusion_selector"', :inaccessible_within, on: Axe::Cucumber.steps

Then 'the page should be accessible excluding "$exclusion_selector"', :accessible_excluding, on: Axe::Cucumber.steps

Then 'the page should not be accessible excluding "$exclusion_selector"', :inaccessible_excluding, on: Axe::Cucumber.steps

Then 'the page should be accessible within "$inclusion_selector" but excluding "$exclusion_selector"', :accessible_within_but_excluding, on: Axe::Cucumber.steps

Then 'the page should not be accessible within "$inclusion_selector" but excluding "$exclusion_selector"', :inaccessible_within_but_excluding, on: Axe::Cucumber.steps
